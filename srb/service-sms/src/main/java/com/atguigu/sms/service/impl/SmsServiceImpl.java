...
public class SmsServiceImpl implements SmsService {
    ...
    public void send(String mobile, String templateCode, Map<String, Object> params) {
        ...
        try {
            ...
            Assert.isTrue(success, ResultEnum.ALIYUN_RESPONSE_ERROR);

            //获取响应结果
            String data = response.getData();
            // 这里使用获取类型 避免警告
            Type hashType = new TypeToken<HashMap<String,String>>() {}.getType();
            HashMap<String, String> resultMap = gson.fromJson(data, hashType);
...
//            e.printStackTrace();
            ...
            log.error("阿里云短信发送sdk调用失败:" + e.getErrCode() + ", " + e.getErrMsg());
            throw new BusinessException(ResultEnum.ALIYUN_RESPONSE_ERROR, e);
//            e.printStackTrace();
        }
    }
