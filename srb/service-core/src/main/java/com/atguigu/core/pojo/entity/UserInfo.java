package com.atguigu.core.pojo.entity;
...
public class UserInfo implements Serializable {
    ...
    public static final String USER_AVATAR = "http://wenyang.life/assets/img/logo.png";
    ...
    //@JsonFormat(pattern = "yyyy-MM-dd")  个性化处理时间类型
